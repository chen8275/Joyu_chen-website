      ...
      if ("string" == typeof e) {
        ...
        if (r[1]) {
          if (
            ...
            x.merge(
              this,
              x.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : o, !0)
            ),
            ...
            ? ((c = t),
              ...
              (S = f.compareDocumentPosition
                ? function(e, n) {
                    ...
                    return r
                      ? 1 & r ||
                        (!b.sortDetached && n.compareDocumentPosition(e) === r)
                        ? e === t || m(v, e)
                          ? -1
                          : n === t || m(v, n)
                            ? 1
  ...
  x.ajaxSetup({
    ...
    x.ajaxPrefilter("json jsonp", function(t, n, r) {
      ...
      return a || "jsonp" === t.dataTypes[0]
        ? ((i = t.jsonpCallback = x.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          a
